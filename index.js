...
app.post("/api/analyze", async (req, res) => {
    try {
        ...
        - location: Lugar del suceso. Preguntar si no es claro. Si dice mi casa o mi (algo) preguntar la dirección exacta.
        ...
        - owner: true o false (si el usuario es el afectado). Preguntar si no es claro.
